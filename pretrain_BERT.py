...
## Required parameters
flags.DEFINE_string(
    "input_file", 'BERT_pos_phase3.txt',
...
# One epoch53230.75
# examples * epoch
flags.DEFINE_integer("num_train_steps", 600, "Number of training steps.")
# 20% of training steps
flags.DEFINE_integer("num_warmup_steps", 120, "Number of warmup steps.")

flags.DEFINE_integer("save_checkpoints_steps", 600,
